...
CREATE TABLE `comment` (
  ...
  CONSTRAINT `FK_comment` FOREIGN KEY (`student`) REFERENCES `user` (`login`),
...
CREATE TABLE `course` (
  ...
  CONSTRAINT `FK_course` FOREIGN KEY (`lecturer`) REFERENCES `user` (`login`)
) ENGINE=InnoDB DEFAULT CHARSET=cp1251;
...
CREATE TABLE `studentanswer` (
  ...
  CONSTRAINT `FK_studentanswer` FOREIGN KEY (`student`) REFERENCES `user` (`login`),
...
CREATE TABLE `studentlesson` (
  ...
  CONSTRAINT `FK_studentlesson` FOREIGN KEY (`student`) REFERENCES `user` (`login`),
...
CREATE TABLE `subscribe` (
  ...
  KEY `StudentIndex` (`student`),
  KEY `CourseIndex` (`course`),
  CONSTRAINT `FK_subscribe` FOREIGN KEY (`student`) REFERENCES `user` (`login`),
...
insert  into `user`(`login`,`hash_pass`,`role`,`user_name`,`description`,`photo`) values ('admin','admin','admin',NULL,NULL,NULL),('lecturer','lecturer','lecturer',NULL,NULL,NULL),('meow','meow','student','Natalie',NULL,NULL),('student','student','student',NULL,NULL,NULL);
